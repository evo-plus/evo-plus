...
enum class Barrel(val color: Color, val instrument: NoteBlockInstrument, val note: Int, val powered: Boolean) {
    ...
    fun isThis(blockState: BlockState) = blockState.run {
        block === Blocks.NOTE_BLOCK
                && get(NoteBlock.INSTRUMENT) === this@Barrel.instrument
                && get(NoteBlock.NOTE) == note
                && get(NoteBlock.POWERED) == powered
    }

    companion object {
        fun isBarrel(blockState: BlockState) =
            NORMAL.isThis(blockState) || NETHER.isThis(blockState) || END.isThis(blockState)

        fun isDetonatingBarrel(blockState: BlockState) =
            NORMAL_DETONATING.isThis(blockState) || NETHER_DETONATING.isThis(blockState) || END_DETONATING.isThis(
                blockState
            )
    }
}
...
enum class Shard(val color: Color, val value: String) {
    ...
    DIAMOND(
        Colors.Diamond,
        "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjE3NjdmYWEzNjZjODA1Nzc5NTJmNWUwMDc4MTU5ZDU5NzdmMzcyMDJmMzhkNDgxN2Q0YTkyNDVhZDQ4YTkwZCJ9fX0="
    ),
    ;

    fun isThis(blockState: BlockState, pos: BlockPos, chunk: Chunk) =
        blockState.isHead() && pos.getPlayerSkullTextureValue(chunk) == value
}
...
enum class LuckyBlock(val color: Color, val value: String) {
    ...
    COMMON(
        Colors.Yellow,
        "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjM4YzBkMmYxZWMyNjc1NGRjYTNjN2NkYWUzMWYxZjE2NDg4M2Q0NTNlNjg4NjQzZGEwNDc1NjhlN2ZhNWNjOSJ9fX0="
    ),
    RARE(
        Colors.Deepskyblue,
        "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmUwMDJkOTc3MjNiOGNjOTgwMmQzMGZlOGU0Y2VmMzYxZTU2Y2YyZTQ5YWU5MWYyNzRkYTcyZjQ3ODEzNDExOCJ9fX0="
    ),
    LEGENDARY(
        Colors.Purple,
        "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTA2ZWExMDRjYjliZTcwM2NjZWQxYjFmNTY1Mjg2NzUyZTI3MTc1MmM1YWM4NWU4MTEzYjNlMmRjNDM1MmMyMCJ9fX0="
    ),
    ;
