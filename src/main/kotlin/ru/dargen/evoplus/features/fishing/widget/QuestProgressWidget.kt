...
data object NormalProgressWidget : QuestProgressWidget("NORMAL") {
...
data object NetherProgressWidget : QuestProgressWidget("NETHER") {
...
class QuestProgressWidget(val typeName: String) : WidgetBase {
