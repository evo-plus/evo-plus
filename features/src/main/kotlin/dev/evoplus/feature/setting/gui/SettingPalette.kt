...
import dev.evoplus.feature.setting.SettingConfig
import dev.evoplus.feature.setting.utils.ImageFactory
import dev.evoplus.feature.setting.utils.ResourceImageFactory
...
object SettingPalette {
    ...
    internal val CANCEL_5X: ImageFactory =
        ResourceImageFactory("/assets/evo-plus/textures/gui/settings/cancel_5x5.png")
    internal val ARROW_LEFT_4X7: ImageFactory =
        ResourceImageFactory("/assets/evo-plus/textures/gui/settings/arrow-left.png")
    internal val ARROW_UP_7X4: ImageFactory =
        ResourceImageFactory("/assets/evo-plus/textures/gui/settings/arrow_up.png")
    internal val ARROW_DOWN_7X4: ImageFactory =
        ResourceImageFactory("/assets/evo-plus/textures/gui/settings/arrow_down.png")
    internal val TOGGLE_ON_1X5: ImageFactory =
        ResourceImageFactory("/assets/evo-plus/textures/gui/settings/toggle_on.png")
    internal val TOGGLE_OFF_4X5: ImageFactory =
        ResourceImageFactory("/assets/evo-plus/textures/gui/settings/toggle_off.png")
