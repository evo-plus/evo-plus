package dev.evoplus.feature.setting.property.data

import dev.evoplus.feature.setting.gui.*
...
class PropertyItem(val data: Property<*, *>) : CategoryItem() {
    ...
    override fun toSettingsObject() = DataBackedSetting(data as Property<Any, *>, data.createComponent())
