...
class NumberComponent(
    ...
    private fun clickControl(control: UIComponent) {
        changeOutlineColor(control, SettingPalette.primary)
        ...
        if (isControlDisabled(control)) {
            changeOutlineColor(control, SettingPalette.textDisabled)
        }
    ...
    private fun releaseControl(control: UIComponent) {
        changeOutlineColor(
            control,
            if (isControlDisabled(control)) SettingPalette.textDisabled else SettingPalette.text
        )
    }
