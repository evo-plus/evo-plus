...
import dev.evoplus.feature.setting.utils.onSetValueAndNow
...
internal class EssentialTooltip(
    ...
    init {
        textColorState.set(SettingPalette.getText())

        this effect OutlineEffect(SettingPalette.getComponentBorderDark(), 1f)
    ...
    override fun draw(matrixStack: UMatrixStack) {
        ...
        if (belowComponent) {
            ...
            for (i in 1..notchSize) {
                UIBlock.drawBlock(
                    matrixStack,
                    SettingPalette.getComponentBorderDark(),
